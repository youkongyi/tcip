...
<body>
	...
	<header class="navbar clearfix" id="header">
		<div class="container">
				<div class="navbar-brand">
					<!-- COMPANY LOGO -->
					<a href="index.html">
						<img src="img/logo/S_tech.png" alt="统一接口平台" class="img-responsive" height="30" width="120">
					</a>
					<!-- /COMPANY LOGO -->
	...
	<section id="page">
					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							<li class="has-sub">
								...
								<i class="fa fa-bookmark-o fa-fw"></i> <span class="menu-text">应用管理</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="sys/token/token_list" target="contentBody"><span class="sub-menu-text">acesse_token管理</span></a></li>
									<li><a class="" href="sys/app/app_list" target="contentBody"><span class="sub-menu-text">应用管理</span></a></li>
									<li><a class="" href="sys/interface/interface_list" target="contentBody"><span class="sub-menu-text">接口管理</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								<i class="fa fa-share"></i> <span class="menu-text">事件管理</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="sys/pushevent/pushevent_list" target="contentBody"><span class="sub-menu-text">事件管理</span></a></li>
									<li><a class="" href="sys/pushevent/pushevent_history" target="contentBody"><span class="sub-menu-text">推送历史</span></a></li>
									<li><a class="" href="test/push_test" target="contentBody"><span class="sub-menu-text">事件测试</span></a></li>
								</ul>
							</li>
							<li>
								<a href="test/test" target="contentBody">
								<i class="fa fa-tachometer fa-fw"></i> <span class="menu-text">接口测试</span>
				...
				<!-- /SIDEBAR -->
		<div id="main-content">
			<iframe id="contentBody" name="contentBody" class="content box" seamless src="#" onload="changeFrameHeight()"  style="border: none;height: 1000px; width: 100%	" ></iframe>
		</div>
	</section>
	<!--/PAGE -->
	<!-- JAVASCRIPTS -->
