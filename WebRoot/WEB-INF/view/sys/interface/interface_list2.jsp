...
<head>
	...
	<script type="text/javascript">
		function load() {
		    	arrayPage(${pageResult.pages},${pageResult.total},"sys/interface/interface_list");
		    }
...
<body onload="load()">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box border blue">
									...
									<div class="box-body">
										<table  cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered box border blue table-hover">
											<thead>
													<tr>
											...
											<tbody>
												...
												<tr class="gradeU">
													<th><input type="checkbox" value="${interService.id }"></th>
	...
	<!-- /JAVASCRIPTS -->
	<!-- BASIC -->
	<div class="modal fade box border orange col-sm-6" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" 
