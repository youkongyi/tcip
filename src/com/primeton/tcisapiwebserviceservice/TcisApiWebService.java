...
@XmlRootElement(name = "tcisApiWebService")
public class TcisApiWebService {

    @XmlElementRef(name = "in0", namespace = "http://www.primeton.com/TcisApiWebServiceService", type = JAXBElement.class, required = false)
